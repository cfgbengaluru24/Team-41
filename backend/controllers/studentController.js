...
const createStudent = async (req, res) => {
    const { fullName, age, class: studentClass, annualIncome, isFunded, state, enrolledBy, fundedFrom, gender } = req.body;
...
const updateStudent = async (req, res) => {
    ...
    try {
        const updatedStudent = await Students.findByIdAndUpdate(
            id,
            { fullName, age, class: studentClass, annualIncome, isFunded, state, enrolledBy, fundedFrom, gender },
            { new: true }
        );
